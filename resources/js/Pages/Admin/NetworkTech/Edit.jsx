...
export default function Edit({ item }) {
    ...
    const submit = (e) => { e.preventDefault(); form.put(route('admin.network-tech.update', item.id)); };
    return (
        <AdminLayout title="Edit Network Tech Item">
            <PageHeader title="Edit Item" actionHref={route('admin.network-tech.index')} actionLabel="Back" />
