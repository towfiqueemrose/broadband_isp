...
export default function Create() {
    const form = useForm({ icon: 'server-stack', title: '', description: '', is_active: true, sort_order: 0 });
    const submit = (e) => { e.preventDefault(); form.post(route('admin.network-tech.store')); };
    return (
        <AdminLayout title="Create Network Tech Item">
            <PageHeader title="Create Item" actionHref={route('admin.network-tech.index')} actionLabel="Back" />
