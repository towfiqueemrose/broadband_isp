...
export default function Create() {
    const form = useForm({ icon: 'bolt', title: '', description: '', is_active: true, sort_order: 0 });

    const submit = (e) => { e.preventDefault(); form.post(route('admin.why-choose-us.store')); };

    return (
        <AdminLayout title="Create Why Choose Us Item">
            <PageHeader title="Create Item" actionHref={route('admin.why-choose-us.index')} actionLabel="Back" />
