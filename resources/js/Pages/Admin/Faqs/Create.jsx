...
export default function Create() {
    const form = useForm({ question: '', answer: '', category: '', display_location: 'all', is_active: true, sort_order: 0 });
                ...
                <FormCard>
                    <div className="space-y-4">
                        ...
                        <div className="grid gap-4 sm:grid-cols-3">
                            <FormInput label="Category" value={form.data.category} onChange={(e) => form.setData('category', e.target.value)} description="Optional grouping" />
