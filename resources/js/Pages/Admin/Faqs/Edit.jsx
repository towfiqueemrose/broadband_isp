...
export default function Edit({ faq }) {
    const form = useForm({ question: faq.question, answer: faq.answer, category: faq.category || '', display_location: faq.display_location || 'all', is_popular: faq.is_popular || false, is_active: faq.is_active, sort_order: faq.sort_order });
