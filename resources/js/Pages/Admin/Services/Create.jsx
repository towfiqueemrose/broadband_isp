            ...
            <form onSubmit={submit} className="max-w-3xl space-y-6">
                <FormCard title="Service Details">
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2"><FormInput label="Slug" value={form.data.slug} onChange={(e) => form.setData('slug', e.target.value)} error={form.errors.slug} description="Auto-generated from title if empty" /></div>
