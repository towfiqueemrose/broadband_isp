...
export default function Create() {
    const form = useForm({ icon: 'heart', title: '', description: '', is_active: true, sort_order: 0 });
    const submit = (e) => { e.preventDefault(); form.post(route('admin.core-values.store')); };
    return (
        <AdminLayout title="Add Core Value">
            <PageHeader title="Add Core Value" actionHref={route('admin.core-values.index')} actionLabel="Back" />
