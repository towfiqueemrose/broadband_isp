...
export default function Create() {
    ...
    const submit = (e) => { e.preventDefault(); form.post(route('admin.company.mission.store'), { forceFormData: true }); };
    return (
        <AdminLayout title="Create Mission">
            <PageHeader title="Create Mission" actionHref={route('admin.company.mission.index')} actionLabel="Back" />
            <form onSubmit={submit} encType="multipart/form-data" className="max-w-3xl space-y-6">
                <FormCard>
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-100">Image (optional)</label>
