...
export default function Edit({ member }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        form.post(route('admin.team.update', member.id), { forceFormData: true });
    };
            ...
            <form onSubmit={submit} encType="multipart/form-data" className="max-w-3xl space-y-6">
                <FormCard title="Basic Info">
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <FormInput label="Designation" value={form.data.designation} onChange={(e) => form.setData('designation', e.target.value)} error={form.errors.designation} />
                ...
                <FormCard title="Contact Details">
                    <div className="grid gap-4 sm:grid-cols-2">
                        <FormInput label="Phone" value={form.data.phone} onChange={(e) => form.setData('phone', e.target.value)} error={form.errors.phone} />
                ...
                <FormCard title="Photo & Status">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div>
                            <label className="block text-sm font-medium text-gray-900">{member.image ? 'Replace Photo' : 'Profile Photo'}</label>
