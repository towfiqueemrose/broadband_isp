                        ...
                        <div key={loc.id} className="rounded-2xl border border-white/5 bg-gray-900 p-5 transition-all hover:border-white/10">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    {loc.address && <p className="mt-1 text-sm text-gray-100">{loc.address}</p>}
                                ...
                                <div className="flex items-center gap-2">
                                    <Link href={route('admin.locations.edit', loc.id)} className="text-gray-100 hover:text-white"><Icon name="edit" className="h-4 w-4" /></Link>
                                    <button onClick={() => handleDelete(loc.id)} className="text-gray-100 hover:text-red-400"><Icon name="trash" className="h-4 w-4" /></button>
                                </div>
                            </div>
                        </div>
                    ))}
