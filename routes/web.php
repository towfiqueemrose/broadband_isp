...
use App\Http\Controllers\Admin\Rbac\UserController;
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Homepage - Hero
    Route::middleware('can:hero.manage')->group(function () {
    ...
    Route::resource('why-choose-us', WhyChooseUsController::class)->except(['show'])
        ->middleware('can:why-choose-us.manage');
    ...
    Route::resource('core-values', CoreValueController::class)->except(['show'])
        ->middleware('can:core-values.manage');
    ...
    Route::middleware('can:mission.manage')->group(function () {
    ...
    Route::middleware('can:vision.manage')->group(function () {
    ...
    Route::middleware('can:journey.manage')->group(function () {
    ...
    Route::resource('faqs', FaqAdminController::class)->except(['show'])
        ->middleware('can:faqs.manage');

    // Contact Inquiries
    Route::middleware('can:inquiries.manage')->group(function () {
    ...
    // Page CTAs
    Route::middleware('can:page-ctas.manage')->group(function () {
